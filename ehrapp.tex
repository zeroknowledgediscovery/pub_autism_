...
\captionN{Screen capture of the page on pypi.org hosting the released application Link: \href{https://pypi.org/project/ehrzero/}{https://pypi.org/project/ehrzero/}}
\end{figure}
%###################################
