...
\def\COLBL{black}
  ...
  \def\COMPA{../data/figfiles/logodds_patternCirculatory.csv}
  \def\COMPB{../data/figfiles/logodds_patternigestive.csv}
  \def\COMPC{../data/figfiles/logodds_patternerinatal.csv}
