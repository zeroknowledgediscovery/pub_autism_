...
\def\COLBL{black}
  ...
  \def\COMPA{../data/figfiles/age_1_logodds_patternImmun.csv}
  \def\COMPB{../data/figfiles/age_1_logodds_patternnfect.csv}
  \def\COMPC{../data/figfiles/age_1_logodds_patternRespira.csv}
  \def\MTYP{MImmun}
  \def\FTYP{FImmun}
  ...
  \def\BWIDTH{8pt}
  \def\BWIDTHB{7pt}
  \clip (.75in,0.25in) rectangle (7.5in,-5in);
...
% } 
  ...
  % xmax=0.03,xmin=-0.03,
    ...
    \end{tikzpicture}};
      ...
      \node [anchor=north west,align=left] (B) at ([xshift=-1.75in]A.north east) {
        \begin{tikzpicture}[text=\TEXTCOL]
%
%   \def\basis{1}
%   \pgfplotsset
...
% }
  ...
  % xmax=0.03,xmin=-0.03,
    ...
    \end{tikzpicture}};
      ...
      \node [anchor=north west,align=left] (C) at ([yshift=-.5in]B.south west) {
        \begin{tikzpicture}[text=\TEXTCOL]
%
  \def\basis{1}
 %  \pgfplotsset
...
% }
  ...
  % xmax=0.03,xmin=-0.03,
    ...
    % \node[] (T) at ([xshift=-1.35in,yshift=2.25in]A.east) {
 ...
 \node[anchor=south west,align=left] (LA) at ([xshift=1in,yshift=0in]A.north west) {{\LARGE A.} Endocrine Nutritional  Metabolic  And Immunity Dis.
 };
  \node[anchor=north west,align=left] (LB) at ([xshift=1in,yshift=0in]$(LA.north west)!(B.west)!(LA.north east)$) {{\LARGE B.} Respiratory Disorders };

  \node[anchor=south west,align=left] (LC) at ([xshift=0in,yshift=0in]$(LB.north west)!(C.north)!(LB.south west)$) {{\LARGE C.} Infectious And Parasitic Diseases
 };
\end{tikzpicture}
