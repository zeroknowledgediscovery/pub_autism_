...
\def\COLBL{black}
  ...
  \def\BWIDTH{6pt}
  \def\BWIDTHB{6pt}
  \clip (.75in,0.25in) rectangle (7.5in,-9.651in);
...
% } 
  ...
  % xmax=0.03,xmin=-0.03,
    ...
    \end{tikzpicture}};
      ...
      \node [anchor=north west,align=left] (B) at ([xshift=-1.65in,yshift=0.075in]A.north east) {
        \begin{tikzpicture}[text=\TEXTCOL]
%
%   \def\basis{1}
%   \pgfplotsset
...
% }
  ...
  % xmax=0.03,xmin=-0.03,
    ...
    \end{tikzpicture}};
      ...
      \node [anchor=north west,align=left] (D) at ([yshift=-.8in]B.south west) {
        \begin{tikzpicture}[text=\TEXTCOL]
%
  \def\basis{1}
 %  \pgfplotsset
...
% }
  ...
  % xmax=0.03,xmin=-0.03,
    ...
    \node[] (T) at ([xshift=-1.35in,yshift=2.25in]B.east) {
...
{{\LARGE C.} Infectious And Parasitic Diseases
 ...
 \node[anchor=south west,align=left] (LD) at ([xshift=0in,yshift=0in]$(LB.north west)!(D.north)!(LB.south west)$) 
{{\LARGE D.} Circulatory Disorders};
